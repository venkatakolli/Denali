...
plot2
#p2<-ggplotly(plot2)
#htmlwidgets::saveWidget(as_widget(p2), "plot2.html")
```
...
plot3
#p3<-ggplotly(plot3)
#htmlwidgets::saveWidget(as_widget(p3), "plot3.html")
```
...
plot4
#p4<-ggplotly(plot4)
#htmlwidgets::saveWidget(as_widget(p4), "plot4.html")
```
...
plot5
#p5<-ggplotly(plot5)
#htmlwidgets::saveWidget(as_widget(p5), "plot5.html")
```
...
p
#p6<-ggplotly(p)
#htmlwidgets::saveWidget(as_widget(p6), "plot6.html")
```
